...
const hasCoordinatorAccess = () => {
    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold mb-6 text-center">
          ...
          Email:{" "}
          <a
            href="mailto:rooseveltdistrictsnowsports@skimohan.com"
            className="text-blue-600 underline"
          >
            rooseveltdistrictsnowsports@skimohan.com
          </a>
        </h2>
 ...
 {hasCoordinatorAccess() && (
          <div className="pb-5">
                  <Link
  href={`${process.env.NEXT_PUBLIC_API_COORDINATORPORTAL_URL}?programId=Roosevelt`}
  ...
  Go to Coordinator's Portal
      ...
      <div>
        <h3 className="text-xl font-bold mb-6 text-center">
          Bus Meeting Location:Southbound on 15th Ave. NE between NE 65th and NE 68th <br /><br />
          Bus RETURN night PICKUP: We plan to have the bus use the bus zone on NE 68th, just north of RHS. Please leave space for the bus to park in the bus zone.
        </h3>
        <ul className="list-disc list-inside mb-6">
          <li>
