...
const Soundview =  () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const fetchedProducts = await getProductsByProgramId("6e3a01b9-65d6-4e79-a6cf-c5befa29bda5");
...
const hasCoordinatorAccess = () => {
  return user?.publicMetadata?.role === 'Soundview-coordinator'; // Adjust based on how you're managing roles
};
 
  return (
    <div className="max-w-4xl mx-auto p-8">
      <h1 className="text-6xl font-bold text-blue-800 mb-6 text-center">
        Soundview Snowsports
      </h1>
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold mb-6 text-center">
          ...
          Email:{" "}
          <a
            href="mailto:soundviewsnowsports@skimohan.com"
            className="text-blue-600 underline"
          >
            soundviewsnowsports@skimohan.com
          </a>
        </h2>
        ...
        {hasCoordinatorAccess() && (
          <div className="pb-5">
             <Link
  href={`${process.env.NEXT_PUBLIC_API_COORDINATORPORTAL_URL}?programId=Soundview`}
  ...
  Go to Coordinator's Portal
      ...
      <div>
        ...
        <ul className="list-disc list-inside mb-6">
          ...
          <li>Participants of this Friday program should be middle school age age</li>
          <li>
