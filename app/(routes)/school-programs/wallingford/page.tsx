...
const hasCoordinatorAccess = () => {
  return user?.publicMetadata?.role === 'Wallingford-coordinator'; // Adjust based on how you're managing roles
};
    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold mb-6 text-center">
          ...
          Email:{" "}
          <a
            href="mailto:wallingfordsnowsports@skimohan.com
"
            className="text-blue-600 underline"
          >
            wallingfordsnowsports@skimohan.com
...
>
  Go to Coordinator's Portal
      ...
      <div>
        ...
        <ul className="list-disc list-inside mb-6">
          <li>
          The bus departs at 4:00 PM andreturns at approximately 11:00 PM- 11:30 PM.
          </li>
          <li>
