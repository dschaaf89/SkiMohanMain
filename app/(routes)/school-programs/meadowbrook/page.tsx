...
const hasCoordinatorAccess = () => {
  return user?.publicMetadata?.role === 'Meadowbrook-coordinator'; // Adjust based on how you're managing roles
};
    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold mb-6 text-center">
          ...
          Email:{" "}
          <a
            href="mailto:meadowbrooksnowsports@skimohan.com"
            className="text-blue-600 underline"
          >
           meadowbrooksnowsports@skimohan.com
          </a>
        </h2>
  ...
  Go to Coordinator's Portal
      ...
      <div>
        <h3 className="text-xl font-bold mb-6 text-center">
          Bus Meeting Location:Meadowbrook Playfield parking lot (10750 30th Ave NE, Seattle, WA 98125)
        </h3>
        <ul className="list-disc list-inside mb-6">
          <li>
