...
const NortheastSeattle = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const fetchedProducts = await getProductsByProgramId("1368e4b7-35e3-4b68-84c9-f4d04d544fd5");
...
const hasCoordinatorAccess = () => {
  return user?.publicMetadata?.role === 'NESeattle-coordinator'; // Adjust based on how you're managing roles
};
    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold mb-6 text-center">
          ...
          Email:{" "}
          <a
            href=" mailto:neseattlesnowsports@skimohan.com"
            className="text-blue-600 underline"
          >
            neseattlesnowsports@skimohan.com
          </a>
        </h2>
 ...
 {hasCoordinatorAccess() && (
          <div className="pb-5">
           <Link
  href={`${process.env.NEXT_PUBLIC_API_COORDINATORPORTAL_URL}?programId=NorthEastSeattle`}
...
export default NortheastSeattle;
