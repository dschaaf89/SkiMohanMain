...
const Ballard = () => {
  ...
  const hasCoordinatorAccess = () => {
    return user?.publicMetadata?.role === 'Ballard-coordinator'; // Adjust based on how you're managing roles
  };
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold mb-6 text-center">
          ...
          Noam Gundle<br />
          Email: <a href="mailto:ballardsnowsports@skimohan.com" className="text-blue-600 underline">ballardsnowsports@skimohan.com</a>
        </h2>
  ...
  Go to Coordinator's Portal
      ...
      <div>
        <h3 className="text-xl font-bold mb-6 text-center">
          Bus Meeting Location: Loading Zone on the street on 67th, just W of the entrance to the school
        </h3>
        <ul className="list-disc list-inside mb-6">
          <li>The bus departs at 3:30 PM and returns at approximately 11:00 PM- 11:30 PM</li>
