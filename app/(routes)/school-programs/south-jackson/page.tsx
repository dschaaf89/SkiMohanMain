...
const SouthJackson = () => {
    ...
    const fetchProducts = async () => {
      try {
        const fetchedProducts = await getProductsByProgramId(
          "0680c611-a2d1-4487-8094-9fc317934139"
        );
  ...
  const hasCoordinatorAccess = () => {
    return user?.publicMetadata?.role === "SouthJackson-coordinator"; // Adjust based on how you're managing roles
  };
  return (
    <div className="max-w-4xl mx-auto p-8">
      <h1 className="text-6xl font-bold text-blue-800 mb-6 text-center">
        South Jackson Snowsports
      </h1>
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold mb-6 text-center">
          ...
          <a
            href="mailto:	
            southjackaonsnowsports@skimohan.com"
            className="text-blue-600 underline"
          >
            southjackaonsnowsports@skimohan.com
          </a>
        ...
        {hasCoordinatorAccess() && (
          <div className="pb-5">
            <Link
              href={`${process.env.NEXT_PUBLIC_API_COORDINATORPORTAL_URL}?programId=SouthJackson`}
