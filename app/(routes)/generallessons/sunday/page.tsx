  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <ul className="list-disc list-inside mb-6">
        ...
        <li><strong>Students 14 years and older who are interested in teaching or assisting should visit our <a href="https://www.skimohan.com/staff/assistant"className="text-blue-600 underline">Job Application page</a>.</strong></li>
