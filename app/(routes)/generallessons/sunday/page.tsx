  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      <h1 className="text-4xl font-bold text-blue-800 mb-6">
        Sunday Ski and Snowboard Lessons
      </h1>
      ...
      <ul className="list-disc list-inside mb-6">
        <li>
          ...
          status, which is updated daily by 6AM.
        </li>
        <li>
          The program offers a fantastic opportunity to help you and/or your
          children improve skills. As skills increase, students may be moved to
          another class to optimize their learning and progress.
        </li>
        <li>
          Student must be 10 years old or older to takes snowboard lessons.
        </li>
        <li>
        ...
        <li>
          Average class size for 5-year-old students is about three. Some may be
          bigger or smaller. Larger classes have assistants assigned. All
          students must be at least 5-years old by the first lesson. Most
          classes have an instructor and assistant, so students learn faster.
        </li>
        <li>
          Average class size for 6 through Adults is under eight students. If
          there are fewer than three registered students for any class, we
          reserve the right to cancel the class or reduce the lesson time to one
          hour.
        </li>
        <li>
...
Any delay or failure in the performance of Mohan Skiing & Boarding (Mohan) hereunder shall be excused if caused by Force Majeure (a cause or event that is not reasonably foreseeable or otherwise caused by or under the control of Mohan, including acts of God). Events that are beyond the reasonable anticipation and control to prevent, avoid, delay, or mitigate are not attributable Mohan failure to perform its obligations under this Agreement.

Prior to the end of the business day, 3pm, on November 30 of the current season, participants may request, in writing, a refund for their lessons and/or transportation. When processed there will be a $25 fee subtracted for each refund.  After 3pm of November 30, participant’s lessons and/or transportation are NOT refundable unless: The program is not completed by April 30. In which case a prorated credit will be applied towards the following season.

Please note that it is typical to postpone program operations throughout the season due to weather or road conditions. The decision to operate or postpone is at the sole discretion of Mohan. The operating status is posted daily on the Mohan website and phone number voicemail. Please check frequently for the latest information.

If a program is postponed, it is our policy to AUTOMATICALLY add a make-up program date to the end of the program schedule until all postponements are completed.
        </p>
      </div>
    </div>
  );
