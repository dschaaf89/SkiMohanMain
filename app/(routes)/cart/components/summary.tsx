...
const SummaryComponent = () => {
  ...
  const [acceptedTeachingPhilosophy, setAcceptedTeachingPhilosophy] =
    useState(false);
  ...
  useEffect(() => {
    if (searchParams.get("success")) {
      ...
      router.push(
        `/student-signup?productCodes=${programCodes}&userId=${userId}&session_id=${searchParams.get(
          "session_id"
        )}`
      );
    }
    ...
    setTermsAccepted(
      acceptedRefundPolicy &&
        acceptedTeachingPhilosophy &&
        acceptedLatenessPolicy
    );
  }, [
    searchParams,
    removeAll,
  ...
  return (
    <div className="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
      ...
      <div className="flex justify-end mt-4">
        <Button onClick={onCheckout} disabled={!userId || !termsAccepted}>
          Proceed to Checkout
        </Button>
      </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              ...
              prevent, avoid, delay, or mitigate are not attributable MSB
      ...
      >
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              At Mohan, our goal is to make every student feel safe and
              confident about themselves and their abilities through their
            ...
            <li>
              We believe learning is a lifelong journey that continues long
              after our lessons are over. Teaching our students how to ski
              safely, with care for themselves and others, is imperative to our
              school.
            </li>
          </ul>
      ...
      >
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              Mohan Skiing & Boarding operates the following lateness policy for
              all its students.
            </li>
            <li>
          ...
          <p>
            By checking the below box, you are agreeing to uphold the above
            policy.
          </p>
        </div>
      </Modal>
